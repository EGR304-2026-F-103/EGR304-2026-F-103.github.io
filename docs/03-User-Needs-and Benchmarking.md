...
| Voice of the Customer                                                                                                                                                                                                                                                                                                                                                                                | Restated Customer Need                                  |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| "This hand exerciser snapped in half after 5 weeks." | 1. The device withstands repeated use without structural failure. (explicit) 2. The device can be used safely by users with limited hand strength or dexterity. (latent)                      |
|                                                                                                                                                                 "Very cheaply made "                                                                                                                                                                | 3. The device is made with durable, high-quality materials. (explicit) 4. The device allows the user to adjust the resistance easily. (explicit)|
|    "The product worked well when it did, but it wasn't able to be put to its full value in my opinion."                                                                                                                                                                                                                                                                                                                                                                                                  | 5.  The device can operate safely at the maximum rated resistance, and the spring will not fail. (explicit)  6. The device can be used in different locations without permanent installation. (latent)           | 
| "I was totally digging this hand gripper...I liked the rubberized handles and the variable levels of resistance. I was using this gripper mainly to warm up my hands before using my heavier captains of crush grippers, and all was fine and dandy until I noticed what looked like grinded pieces of the plastic on my lap. Appears that the handles are rubbing against each other at the hinge, causing a shredding of the plastic. Garbage product."       | 6. The device maintains its material integrity at points of repeated contact. (explicit) 7. The device retains a smooth and consistent motion throughout repeated use. (latent) 8. The device contains worn material so that loose debris does not reach the user. (latent)    |
|"No grip" |9. The device provides a secure, non-slip grip during use. (explicit) 10. The device remains stable in the user’s hand during exercise. (latent)  |
