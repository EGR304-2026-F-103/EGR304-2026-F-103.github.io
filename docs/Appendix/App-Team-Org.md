...
Asynchronous communication will primarily take place through the team's
group text message. Team members are expected to respond to messages
within 12 hours on weekdays. Synchronous communication will take place
through scheduled Discord voice calls or face-to-face meetings.
...
project work: [EGR 304 Team 103 Project](https://drive.google.com/drive/folders/1jXhHvmIJfAgbNaU0O00NgcHK1z8IIgfq?usp=drive_link). File naming follows the convention
...
**Shared availability.** The team has four hours of common availability
outside of class time: Monday from 5:00-6:00 PM, Wednesday from
5:00-6:00 PM, and Friday from 6:00-8:00 PM.
...
The team agrees that any disagreements should be discussed openly and respectfully rather than ignored. Differences in technical opinions are expected during collaboration, and the team will compare different ideas based on project requirements, available evidence, and testing results. A regular disagreement can become a conflict of interest when responsibilities are poorly divided or one member holds too many roles, so the team will use role rotation system and balanced task distribution to reduce this risk. When a conflict arises, the members involved will first discuss the problem together, explore all possible solutions, and attempt to reach an agreement. If the issue cannot be resolved within the team after repeated discussion, or if it begins to significantly slow down the progress, project quality, or team participation, the team will contact the instructor for guidance.
...
diagnose repository configuration issues, and draft or refine the Team
Charter and Product Mission Statement. The generated language was reviewed
and approved by the team, while factual team decisions, schedules, role
assignments, and signatures were provided by the team members.
...
Gabriel Toneser Facchin confirmed that he did not use generative AI for this assignment.